...
;; Remember bring the spacemacs repo from develop.
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-additional-packages '(drag-stuff atom-one-dark-theme)
...
(defun dotspacemacs/user-init ()
  ;; Org mode settings
  (setq org-todo-keywords '((sequence "TODO" "PROGRESS" "|" "DONE" "DISCARD")))
...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("/mnt/c/Users/suabochica/Google Drive/sua.org")))
